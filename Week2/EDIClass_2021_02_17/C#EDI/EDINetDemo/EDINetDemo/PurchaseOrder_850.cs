...
namespace indice.Edi.Tests.Models
{
    ...
    public class PurchaseOrder_850
    {
        ...
        public class OrderDetail
        {
            ...
            [EdiValue(Path = "PO1/5", Description = "PO106 - Qualifier for Buyer’s Part #.")]
            public string BuyersPartnoQualifier { get; set; }

            [EdiValue(Path = "PO1/6", Description = "PO107 - Buyer’s Part #.")]
            public string BuyersPartno { get; set; }

            [EdiValue(Path = "PO1/8", Description = "PO109 - Vendor’s Part #.")]
